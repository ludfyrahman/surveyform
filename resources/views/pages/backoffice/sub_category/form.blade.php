                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Slug <span class="tx-danger">*</span></label>
                                    <input type="text" readonly name="slug"
                                        class="form-control bg-light @error('slug') parsley-error @enderror" placeholder="slug"
                                        value="{{ $data->slug == '' ? old('slug') : $data->slug }}">
                                    @error('slug')
                                        <ul class="parsley-errors-list filled" id="parsley-id-5">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>
