                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                ...
                                <span class="float-end my-auto ms-auto">
                                    <i
                                        class="fas fa-arrow-circle-{{ $summary->saleTodayBefore < 0 ? 'down' : 'up' }} text-white"></i>
                    ...
                    <div class="ps-3 pt-3 pe-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                ...
                                <span class="float-end my-auto ms-auto">
                                    <i
                                        class="fas fa-arrow-circle-{{ $summary->saleMonthBefore < 0 ? 'down' : 'up' }} text-white"></i>
                                    <span class="text-white op-7">
                                        {{ round($summary->saleMonthBefore, 2) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ps-3 pt-3 pe-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                ...
                                <span class="float-end my-auto ms-auto">
                                    <i
                                        class="fas fa-arrow-circle-{{ $summary->purchaseMonthBefore < 0 ? 'down' : 'up' }} text-white"></i>
                                    <span class="text-white op-7"> {{ round($summary->purchaseMonthBefore, 2) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-5 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header pb-1">
                        ...
                        <p class="tx-12 mb-0 text-muted">Customer adalah individu yang membeli barang atau menggunakan jasa
                            pada aplikasi ini.</p>
                    </div>
                            ...
                            @foreach ($customers as $customer)
                                <div class="list-group-item list-group-item-action" href="#">
                                    <div class="media mt-0">
                                        <img class="avatar-lg rounded-circle me-3 my-auto"
                                            src="../../assets/img/faces/3.jpg" alt="Image description">
                                        <div class="media-body">
                                            <div class="d-flex align-items-center">
                                                <div class="mt-0">
                                                    <h5 class="mb-1 tx-15">{{ $customer->nama }}</h5>
                                                    <p class="mb-0 tx-13 text-muted">User ID: #{{ $customer->id }} <span
                                                            class="text-{{ $customer->status == 'Aktif' ? 'success' : 'danger' }} ms-2">{{ $customer->status }}</span>
                                                    </p>
                                                </div>
            ...
            <div class="col-xl-4 col-md-12 col-lg-6">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <p class="tx-12 mb-0 text-muted">Pemesanan barang atau penggunaan jasa pada aplikasi tercantum pada
                            grafik dibawah ini.</p>
                    </div>
