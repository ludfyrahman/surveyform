            ...
            <div class="card-body">
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal"
                        action="{{ $data->type == 'create' ? route('customer.store') : route('customer.update', $data->id) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telepon"
                                        class="form-control @error('telepon') parsley-error @enderror" placeholder="telepon"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telepon_instansi"
                                        ...
                                        placeholder="Telepon Instansi(Opsional)"
                                        value="{{ $data->telepon_instansi ?? old('telepon_instansi') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat"
                                        class="form-control @error('alamat') parsley-error @enderror" placeholder="alamat"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="" class="form-control" required>
                                            ...
                                            <option {{ $status == 'Aktif' ? 'selected' : '' }} value="Aktif">Aktif
                                            </option>
